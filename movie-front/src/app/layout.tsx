...
export default function RootLayout({
  ...
  return (
    <Provider store={store}>
      <html lang={language}>
        <body
          className={`flex flex-col min-h-screen  items-center ${inter.className} overflow-x-hidden`}
        >
          <div className="xl:w-1440 w-full md:mx-60 lg:mx-120 overflow-x-hidden">
            <div className="flex flex-col justify-between min-h-screen mx-2 bg-[#093545] overflow-x-hidden">
              <div className="p-4 flex justify-end">
                <select
                  value={language}
                  onChange={handleLanguageChange}
                  className="p-2 border rounded-md bg-[#093545] text-white"
                >
